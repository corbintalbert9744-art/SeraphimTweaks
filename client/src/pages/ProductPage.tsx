      ...
      <nav className="fixed top-0 w-full z-50 bg-black/70 backdrop-blur-xl border-b border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => window.open('https://discord.gg/zFZxh9RKdC', '_blank')} className="text-sm text-neutral-400 hover:text-white transition-colors flex items-center gap-1.5">
