      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700" style={{ animationDelay: '240ms' }}>
            ...
            <button
              onClick={() => window.open('https://discord.gg/zFZxh9RKdC', '_blank')}
              className={`btn-3d w-full sm:w-auto px-8 py-4 bg-[#5865F2] rounded-2xl font-semibold text-lg text-white inline-flex items-center justify-center gap-2.5 ${clickableStyles}`}
            >
