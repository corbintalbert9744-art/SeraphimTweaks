...
def nba_props(
    ...
    """Live NBA research board — filtered to the selected pick'em platform when set."""
    ...
    return {
        **payload,
        ...
        "markets": ["All", *markets],
        "live": True,
        "disclaimer": "Projections are Seraphim model estimates — only lines available on the selected pick'em app are shown.",
    }
