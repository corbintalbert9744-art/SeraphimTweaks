    ...
    return {
        "leagues": [
            ...
            },
            {
                ...
                "notes": "ESPN soccer scoreboards (no key). Optional FOOTBALL_DATA_API_KEY enrichment. Player prop logs not fabricated.",
            },
            {
                "code": "ATP",
                "status": "partial",
                "provider": "espn-tennis",
                "notes": "ESPN ATP schedule (no key). Match props not fabricated. Tennis Abstract not scraped. ODDS_API_KEY for tournament odds when keys verified.",
            },
            {
                "code": "WTA",
                "status": "partial",
                "provider": "espn-tennis",
                "notes": "ESPN WTA schedule (no key). Match props not fabricated. Tennis Abstract not scraped. ODDS_API_KEY for tournament odds when keys verified.",
            },
        ],
